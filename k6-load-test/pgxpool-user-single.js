...
export let options = {
    ...
    vus: 1, // virtual users
    stages: [
        { duration: '25s', target: 30000 }, // simulate ramp-up of traffic from 1 to 100 users over 5 minutes
        { duration: '60s', target: 30000 }, // stay at 100 users for 10 minutes
        { duration: '25s', target: 0 }, // ramp-down to 0 users
    ],
    thresholds: {
...
export default () => {
    const res = http.get('http://localhost:8889/users/1')
